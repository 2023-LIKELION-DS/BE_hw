...
if a ==1 or a==2 :
    ...
    if a==1:
        print("%d원이 입금되었습니다. 현재 잔고는 %d원 입니다." % (b, b+money))
    if a == 2:
        if (money==b):
            print("통장을 파기합니다.")
        elif (money<b):
            print("현재 잔고가 부족합니다. %d원이 부족합니다." % (b-money))
        elif (money>b):
            print("%d원이 출금되었습니다. 현재 잔고는 %d원입니다." % (b, money-b))
else:
    exit()
...
order_num=random.randrange(1,7)

for i in range(order_num):
    table_num=random.randrange(1,7)
    food_choice=random.choice(food)
    print("%d번째 테이블에서 %s을(를) 주문했습니다." % (table_num, food_choice))
...
for i in range(1,201):
    mbti_person.append(random.choice(mbti))
...
counter = Counter(mbti_person)
dict_mbti=dict(counter)
print(dict_mbti)
...
print("mbti가", a, "인 사람은 총", dict_mbti[a], "명 입니다.") 