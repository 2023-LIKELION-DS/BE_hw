...
while(True):
  print("\n")
  ans = int(input("입금이면 1, 출금이면 2 (종료는 아무거나 누르세요): "))
  ...
  if ans == 1:
      ...
      account += money
      print("%d원 입금되었습니다. 현재 잔고는 %d원 입니다." %(money, account))
      ...
      if (account < money) :
          print('현재 잔고 부족입니다. %d원이 부족합니다.' %(money - account))
          continue
      ...
      if (account == 0):
          ...
          print("%d원 출금되었습니다. 현재 잔고는 %d원 입니다." %(money, account))
